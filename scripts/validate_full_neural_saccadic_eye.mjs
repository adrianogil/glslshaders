...
for(const [key,path] of Object.entries({shader_sha256:'03_raymarching/12_full_neural_saccadic_eye.frag',checkpoint_sha256:'scripts/full_eye_gaze/full_neural_saccadic_eye.pt',training_source_sha256:'scripts/full_eye_gaze/train.py',base_source_sha256:'scripts/full_eye/train.py',template_sha256:'scripts/full_eye_gaze/shader_template.txt',parity_sha256:'03_raymarching/full_neural_saccadic_eye_parity.json',comparison_sha256:'03_raymarching/full_neural_saccadic_eye_comparison.png'}))assert.equal(model[key],hash(join(root,path)),key);
